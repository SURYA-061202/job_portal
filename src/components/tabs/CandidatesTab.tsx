                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                        ...
                                        <div className="flex items-start gap-3">
                                            {(isFilteringApplicants || onBack) && (
                                                <button
                                                    onClick={onBack}
                                                    className="p-1.5 mt-0.5 rounded-lg text-brand hover:text-gray-900 hover:bg-brand/10 transition-colors flex-shrink-0"
                                                    title="Back"
                                                >
                                            ...
                                            <div>
                                                ...
                                                {!postId && (
                                                    <p className="text-sm text-brand">Review and manage candidate applications and profiles</p>
                                                )}
                                            </div>
                                        </div>
                                            ...
                                            {!postId && !isFilteringApplicants && viewMode !== 'registered-users' && (
                                                <button
                                                    ...
                                                    className={`p-2 rounded-lg transition-all ${showPostView
                                                        ...
                                                        : 'bg-surface text-brand border border-brand/20 hover:bg-brand/10'
                                                        }`}
                                            ...
                                            {viewMode === 'registered-users' && (
                                                <div className="relative">
                                                    <select
                                                        ...
                                                        className="appearance-none bg-surface border border-brand/30 text-gray-700 py-2 pl-3 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-surface focus:border-brand text-sm h-full"
                                                    >
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                            {postCards.map((post) => (
                                                <div
                                                    ...
                                                    className="bg-surface rounded-2xl border border-brand/20 hover:border-brand/20 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer overflow-hidden group"
                                                >
                                                    {/* Top accent bar */}
                                                    ...
                                                    <div className="p-4 sm:p-6 flex-1 flex flex-col">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4">
                                                            {post.yearsExperience && (
                                                                <div className="bg-brand/5 p-2 rounded-lg border border-brand/20">
                                                                    <div className="text-[10px] font-bold text-brand uppercase tracking-wider mb-0.5">Experience</div>
                                                                    <div className="flex items-center text-xs sm:text-sm font-medium text-gray-900">
                                                                        <Clock className="w-3 h-3 mr-1 text-brand" />
                                                                        {post.yearsExperience}
                                                                    </div>
                                                                </div>
                                                            )}
                                                            {post.location && (
                                                                <div className="bg-brand/5 p-2 rounded-lg border border-brand/20">
                                                                    <div className="text-[10px] font-bold text-brand uppercase tracking-wider mb-0.5">Location</div>
                                                                    <div className="flex items-center text-xs sm:text-sm font-medium text-gray-900">
                                                        ...
                                                        {post.skills && (
                                                            <div className="flex flex-wrap gap-1 mb-4">
                                                                {post.skills.split(',').slice(0, 3).map((skill: string, i: number) => (
                                                                    <span key={i} className="text-[10px] px-2 py-0.5 bg-brand/5 border border-brand/20 text-brand font-bold rounded">
                                                                        {skill.trim()}
                                                                    </span>
                                                                ))}
                                                            </div>
                                                        ...
                                                        {/* Footer */}
                                                        <div className="mt-auto pt-3 border-t border-brand/10 flex items-center justify-between">
                                                            {post.createdAt && (
