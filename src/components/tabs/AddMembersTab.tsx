            ...
            <div className="bg-surface p-4 rounded-xl border border-brand/20">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-brand">Manage your recruitment team and assign manager roles</p>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {filteredMembers.map(member => (
                    <div
                        ...
                        className="bg-surface p-6 rounded-xl border border-brand/20 hover:shadow-lg hover:border-brand/30 transition-all duration-200 group cursor-pointer"
                    >
                        {/* Avatar and Badge */}
                        <div className="flex flex-col items-center mb-4">
                            <div className="w-20 h-20 bg-brand/20 rounded-full flex items-center justify-center text-brand font-bold text-2xl mb-3 group-hover:scale-105 transition-transform duration-200">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-center text-sm text-gray-900 bg-brand/5 px-3 py-2 rounded-lg border border-brand/20 group-hover:bg-brand/10 transition-colors">
                                <Mail className="w-4 h-4 text-brand flex-shrink-0 mr-2" />
                        ...
                        <form onSubmit={handleAddMember} className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2.5 bg-white border border-brand/30 rounded-lg focus:ring-2 focus:ring-brand outline-none transition-all"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="pt-4 flex gap-3">
                                <button
                                    ...
                                    className="flex-1 py-2.5 text-gray-700 font-bold bg-brand/10 hover:bg-brand/20 rounded-lg transition-all"
                                >
                                    Cancel
                                </button>
                                <button
