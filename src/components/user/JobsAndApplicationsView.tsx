                ...
                <div className="w-full max-w-4xl bg-white border border-gray-200 rounded-2xl p-1.5 flex flex-col md:flex-row items-center gap-2 shadow-lg shadow-gray-200/50 transition-all duration-300 focus-within:shadow-orange-500/10 focus-within:border-orange-300">
                    <div className="relative flex-1 w-full group">
                        ...
                        <input
                            ...
                            className="w-full font-inter pl-12 pr-4 py-3 bg-transparent rounded-xl focus:outline-none text-gray-900 text-sm md:text-base placeholder:text-gray-400"
                        />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        <div className="flex items-center justify-between w-full sm:w-auto">
                            ...
                            <button
                                ...
                                className="lg:hidden flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-700"
                            >
