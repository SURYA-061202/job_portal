            ...
            <div className="bg-white border-b border-gray-100 sticky top-0 z-20 px-6 py-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 w-full">
                    ...
                    <div className="flex items-center gap-5">
                        <button
                            onClick={onBack}
                            className="p-2 rounded-full transition-all text-gray-400 hover:text-orange-600 hover:bg-orange-50"
                        >
                            <ChevronLeft className="w-5 h-5" />
                        </button>
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 leading-tight tracking-tight">{recruitment.jobTitle}</h1>
                        ...
                        {isManager ? (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-500 to-pink-600 text-white text-sm font-bold rounded-lg hover:shadow-lg hover:shadow-orange-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all"
                                >
                            ...
                            <>
                                {checkingProfile ? (
                                    <button disabled className="px-5 py-2 bg-gray-100 text-gray-400 text-sm font-bold rounded-lg flex items-center gap-2">
                                        <Loader2 className="w-3.5 h-3.5 animate-spin" />
                                        Checking...
                                    </button>
                                ) : hasApplied ? (
                                    <span className="px-5 py-2 bg-emerald-50 text-emerald-700 text-sm font-bold rounded-lg border border-emerald-100 flex items-center gap-2">
                                    ...
                                    <button
                                        onClick={handleApply}
                                        disabled={actionLoading}
                                        className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-orange-500 to-pink-600 text-white text-sm font-bold rounded-lg shadow-lg shadow-orange-500/30 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:grayscale"
                                    >
                                        {actionLoading ? (
